...
namespace OutDinner.Infrastructure.Migrations
{
    ...
    [Migration("20230501094659_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutDinner.Domain.Menus.Menu", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("OutDinner.Domain.Menus.Menu", b =>
                {
                    b.OwnsOne("OutDinner.Domain.Common.ValueObjects.AverageRating", "AverageRating", b1 =>
                        {
                    ...
                    b.OwnsMany("OutDinner.Domain.Dinners.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("OutDinner.Domain.MenuReview.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("OutDinner.Domain.Menus.Entities.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("OutDinner.Domain.Menus.Entities.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("uniqueidentifier")
