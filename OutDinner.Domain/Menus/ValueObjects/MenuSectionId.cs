...
namespace OutDinner.Domain.Menus.ValueObjects;
...
public sealed class MenuSectionId : ValueObject
{
    ...
    public static MenuSectionId CreateUnique() { return new(Guid.NewGuid()); }

    public static MenuSectionId Create(Guid value) { return new(value); }
