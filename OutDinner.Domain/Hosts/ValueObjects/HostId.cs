...
namespace OutDinner.Domain.Hosts.ValueObjects;
...
public sealed class HostId : AggregateRootId<Guid>
{
    ...
    public static HostId CreateUnique() { return new HostId(Guid.NewGuid()); }

    public static HostId Create(Guid value) { return new HostId(value); }
