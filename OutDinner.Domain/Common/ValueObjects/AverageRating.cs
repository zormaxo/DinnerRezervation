...
namespace OutDinner.Domain.Common.ValueObjects;
...
public sealed class AverageRating : ValueObject
{
    ...
    public static AverageRating CreateNew(double rating = 0, int numRatings = 0) { return new AverageRating(rating, numRatings); }
